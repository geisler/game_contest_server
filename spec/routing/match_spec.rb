...
describe Match do
  ...
  describe "unavailable routes" do
    ...
    #specify { expect(post('/contests/1/matches/')).not_to be_routable } removed when challenge functionality was added.
    ...
    #specify { expect(get('/contests/1/matches/new')).not_to be_routable } removed when challenge functionality was added.
    ...
    #specify { expect(delete(match_path(1))).not_to be_routable } removed when challenge functionality was added.
    ...
    #specify { expect(get('/matches/new')).not_to route_to(action: 'new') } removed when challenge functionality was added.
  end
end
